 ...
 * 
 * @export
 * @interface PutUserSingleRequest
 */
export interface PutUserSingleRequest {
    /**
     * 
     * @type {number}
     * @memberof PutUserSingleRequest
     */
    'kudos'?: number;
    /**
     * 
 ...
 * 
 * @export
 * @interface PutWorkerSingleRequest
 */
export interface PutWorkerSingleRequest {
    /**
     * 
     * @type {boolean}
     * @memberof PutWorkerSingleRequest
     */
    'maintenance'?: boolean;
    /**
     * 
...
export const V2ApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @param {string} userId 
         * @param {string} apikey The Admin API key
         * @param {PutUserSingleRequest} payload 
         * @param {string} [xFields] An optional fields mask
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        putUserSingle: async (userId: string, apikey: string, payload: PutUserSingleRequest, xFields?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'userId' is not null or undefined
         ...
         * @param {string} workerId 
         * @param {string} apikey The Moderator or Owner API key
         * @param {PutWorkerSingleRequest} payload 
         * @param {string} [xFields] An optional fields mask
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        putWorkerSingle: async (workerId: string, apikey: string, payload: PutWorkerSingleRequest, xFields?: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'workerId' is not null or undefined
...
export const V2ApiFp = function(configuration?: Configuration) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        async putUserSingle(userId: string, apikey: string, payload: PutUserSingleRequest, xFields?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ModifyUser>> {
         ...
         * @throws {RequiredError}
         */
        async putWorkerSingle(workerId: string, apikey: string, payload: PutWorkerSingleRequest, xFields?: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ModifyWorker>> {
...
export const V2ApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    ...
    return {
         ...
         * @throws {RequiredError}
         */
        putUserSingle(userId: string, apikey: string, payload: PutUserSingleRequest, xFields?: string, options?: any): AxiosPromise<ModifyUser> {
         ...
         * @throws {RequiredError}
         */
        putWorkerSingle(workerId: string, apikey: string, payload: PutWorkerSingleRequest, xFields?: string, options?: any): AxiosPromise<ModifyWorker> {
...
export class V2Api extends BaseAPI {
     ...
     * @memberof V2Api
     */
    public putUserSingle(userId: string, apikey: string, payload: PutUserSingleRequest, xFields?: string, options?: AxiosRequestConfig) {
     ...
     * @memberof V2Api
     */
    public putWorkerSingle(workerId: string, apikey: string, payload: PutWorkerSingleRequest, xFields?: string, options?: AxiosRequestConfig) {
